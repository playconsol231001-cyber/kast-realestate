    ...
    <section id="eligibility" className="py-32 relative bg-[#010411]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl md:text-6xl font-[1000] text-white mb-8 tracking-tighter uppercase italic leading-[0.9]">
              Simplified <br/> <span className="gradient-text">Onboarding.</span>
            </h2>
            <p className="text-slate-500 text-lg mb-10 font-medium italic leading-relaxed">
            ...
            <div className="space-y-4">
              {ELIGIBILITY.map((item) => (
                <div key={item.id} className="flex justify-between items-center py-5 border-b border-white/5 group hover:bg-white/5 transition-colors px-4 rounded-xl">
                  ...
                  <span className="text-white font-black italic uppercase tracking-tighter">{item.value}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="mt-12 lg:mt-0">
            <div className="glass p-10 rounded-[3rem] border-white/10 relative overflow-hidden group">
               ...
               <h3 className="text-2xl font-[1000] text-white mb-8 italic uppercase tracking-tighter">Verified Credentials</h3>
               ...
               <div className="mt-12 pt-8 border-t border-white/10">
                 <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] italic">*Digital verification takes less than 12 hours.</p>
               </div>
            </div>
          </div>
        </div>
